...
// footer into one frame (/docs/design.md §9). Nothing here touches tea.Msg or
...
// sidebarWidth is the shell's SIDEBAR column width (/docs/design.md §9). It
...
// titleBarText is /docs/design.md §9's title line.
...
// /docs/design.md §9. It never returns a line wider than width or more lines than
