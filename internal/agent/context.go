...
// full message list in the exact five-part order /PLAN.md §11.3 specifies.
...
// /PLAN.md §11.3 specify, in the one order that is ever legal: the system
...
// in backbone §9's exact order (/PLAN.md §11.3):
//
