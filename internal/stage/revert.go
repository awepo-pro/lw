...
// directly (/docs/design.md §7). Owned by S2-T6.
package stage
...
// is a proposal like any other (/docs/design.md §7) — and it never takes the
...
func (e *Engine) buildRevertOps(commitID string, prev, cur Snapshot, renames []revertRename, added, removed, changed []string) (ops []Op, skipped []string, err error) {
	...
	// one defect /docs/design.md §1 cannot ship. TestRevertMergeReportsUncoveredPaths
