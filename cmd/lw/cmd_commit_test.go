...
// TestCmdCommitNoBaselinePasses covers backbone §5.7 D-AG verbatim: a
// vault with no prior commit_end has no baseline, so the regression check
// passes outright — gate G2's own first commit is exactly this case.
